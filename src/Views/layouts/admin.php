...
<body class="min-h-screen flex font-sans antialiased <?php echo $useHeader ? 'flex-col' : ''; ?>">
    ...
    <?php else: ?>
        ...
        <aside class="w-64 border-r border-border bg-card hidden md:flex flex-col sticky top-0 h-screen shrink-0">
            <div class="h-16 md:h-20 flex items-center px-6 border-b border-border shrink-0">
                <a class="flex items-center space-x-2 py-2" href="/">
                    <img src="/assets/images/logo.png" alt="BetterDeutsch Logo" class="h-10 md:h-14 w-auto object-contain">
                </a>
            </div>
        ...
        <aside id="mobile-drawer" class="fixed top-0 left-0 z-50 h-screen w-64 bg-card border-r border-border flex flex-col md:hidden">
            <div class="h-16 flex items-center justify-between px-6 border-b border-border shrink-0">
                <a class="flex items-center space-x-2 py-2" href="/">
                    <img src="/assets/images/logo.png" alt="BetterDeutsch Logo" class="h-10 w-auto object-contain">
                </a>
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <?php if (!isset($hideHeaderFooter) || !$hideHeaderFooter): ?>
            <header class="md:hidden sticky top-0 z-30 w-full border-b border-border bg-background/95 backdrop-blur flex h-16 items-center px-4 shrink-0 gap-3">
